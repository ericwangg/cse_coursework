...
int main(int argc, char *argv[])
{
    ...
    for(int i = 0; i< n; i++)
    {
        ...
        {   
            ...
            {
                //Add your code here
				b[moves - 1] = cur;		// store moves -1 in cur
				moves += 1;				// move increment, +1
				cur += a[cur];			// set position to current location 
            }
        }
        else
        {
            ...
            {
                //Add your code here
                b[moves - 1] = cur;		// store moves -1 in cur, Eureka!
				moves += 1;			// still increment moves
				cur -= a[cur];			// still set position to current location
            }
        }
    }
    return 0;
