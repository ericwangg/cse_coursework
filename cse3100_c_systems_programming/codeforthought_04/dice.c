...
double cum_prob(int k, long n)
{
    ...
    double i; // for calculations in with prob later out of for loop
// EW: k = sum 3 of dice or something like that
// EW: n = # of trials
// EW: i = the iteration counter
